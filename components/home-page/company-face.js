    ...
    <div>
      ...
      <div className={classes.face_text}>
        ...
        <p>
          ...
          installation. Vi värdesätter en tydlig kommunikation om tid, utförande
          och kostnad. Ett tydligt upplägg och skickligt utförande är hur vi
          bedriver vår verksamhet. tveka inte att kontakta oss för ett snabbt
          och kvalitativt utförande!
        </p>
      </div>
